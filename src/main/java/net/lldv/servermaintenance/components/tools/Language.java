package net.lldv.servermaintenance.components.tools;
...
public class Language {
    ...
    public static void init() {
        messages.clear();
        ServerMaintenance.getInstance().saveResource("messages.yml");
        Config m = new Config(ServerMaintenance.getInstance().getDataFolder() + "/messages.yml");
